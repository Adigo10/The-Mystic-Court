...
2. Enter an idea pitch. The frontend opens an EventSource stream to `/api/debate/stream`, while the backend fetches Exa snippets and runs five `gpt-5.4-mini` personas in parallel for two rounds.
